            ...
            if (parts.Length > 0)
            {
                ...
                switch (parts[0])
                {
                    ...
                    case "Ns":
                        ...
                        break;
                    case "map_Kd":
                        CurrentMaterial.DiffuseTexture = Texture.FromArgs(parts[1..^1]);
                        break;
                    case "map_Ka":
                        CurrentMaterial.AmbientTexture = Texture.FromArgs(parts[1..^1]);
                        break;
                    case "map_Ks":
                        CurrentMaterial.SpecularTexture = Texture.FromArgs(parts[1..^1]);
                        break;
                    case "map_d":
                        CurrentMaterial.AlphaTexture = Texture.FromArgs(parts[1..^1]);
                        break;
                    case "map_bump":
                    case "bump":
                        CurrentMaterial.BumpTexture = Texture.FromArgs(parts[1..^1]);
                        break;
                }
            }
        }
