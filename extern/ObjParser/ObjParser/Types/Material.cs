...
namespace ObjParser.Types
{
    public class Material : IType
    {
        ...
        public Texture? SpecularTexture { get; set; } = null;
        public Texture? AlphaTexture { get; set; } = null;
        public Texture? BumpTexture { get; set; } = null;
        ...
        public override string ToString()
        {
            ...
            if (AmbientTexture != null) b.AppendLine(string.Format("map_Ka {0}", AmbientTexture.ToString()));
            if (DiffuseTexture != null) b.AppendLine(string.Format("map_Ka {0}", DiffuseTexture.ToString()));
            if (SpecularTexture != null) b.AppendLine(string.Format("map_Ka {0}", SpecularTexture.ToString()));
            if (AlphaTexture != null) b.AppendLine(string.Format("map_Ka {0}", AlphaTexture.ToString()));
            if (BumpTexture != null) b.AppendLine(string.Format("map_Ka {0}", BumpTexture.ToString()));
